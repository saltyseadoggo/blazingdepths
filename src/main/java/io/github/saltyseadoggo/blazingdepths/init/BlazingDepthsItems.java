...
public class BlazingDepthsItems {
    public static final Item SEARED_SEALANT = register("seared_sealant", new SearedSealantItem(new Item.Settings().group(BlazingDepths.CREATIVE_TAB).rarity(Rarity.RARE)));
    public static final Item ANCIENT_CONCOCTION = register("ancient_concoction", new Item(new Item.Settings().group(BlazingDepths.CREATIVE_TAB).rarity(Rarity.UNCOMMON)));
